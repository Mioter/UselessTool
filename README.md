...
🔸 [Dynamic Theme ](https://github.com/jamesnetgroup/dynamic-theme)<br>
🔸 [WPFUiBase](https://github.com/Gilfoylex/WPFUiBase)

### 📚 使用的库

🔹 [EleCho.WpfSuite](https://github.com/OrgEleCho/EleCho.WpfSuite "感谢 SlimeNull")<br>
🔹 [CalcBinding](https://github.com/che77a38/CalcBinding)<br>
